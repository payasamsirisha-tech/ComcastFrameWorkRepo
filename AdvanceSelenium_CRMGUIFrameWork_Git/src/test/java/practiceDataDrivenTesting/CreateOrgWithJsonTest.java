...
public class CreateOrgWithJsonTest {
	
	@Test

	public  void createorg() throws FileNotFoundException, Throwable {
		//read data from json

		JSONParser parser=new JSONParser();
       Object obj=parser.parse(new FileReader("C:\\Users\\USER\\OneDrive\\Desktop\\Excel\\appcommon.json"));
